...
const Chat = () => {
  return (
    ...
    <div class="bg-purple-700 p-4 text-white flex justify-between items-center">
      <button id="login" class="hover:bg-purple-400 rounded-md p-1">
      ...
      <button id="setting" class="hover:bg-purple-400 rounded-md p-1">
    ...
    <div class="flex-1 overflow-y-auto p-4">
        <div class="flex flex-col space-y-2">
            ...
            <div class="flex justify-end">
                <div class="bg-purple-200 text-black p-2 rounded-lg max-w-xs">
    ...
    <div class="bg-white p-4 flex items-center">
        ...
        <button class="bg-purple-700 text-white rounded-full p-2 ml-2 hover:bg-purple-600 focus:outline-none">
