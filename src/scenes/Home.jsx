        ...
        <section className="bg-white dark:bg-gray-900">
          <div className="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div className="place-self-center mr-auto lg:col-span-7">
              ...
              <a
                href="/sign-in"
                className="inline-flex justify-center items-center py-3 px-5 mr-3 text-base font-medium text-center text-black rounded-lg bg-white-700 hover:bg-violet-600 hover:text-white focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900 border-2 border-black hover:border-white"
              >
                Get started
                <svg
          ...
          <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            ...
            <div className="grid grid-cols-2 gap-8 text-gray-500 sm:gap-12 md:grid-cols-3 lg:grid-cols-6 dark:text-gray-400">
              <a href="#" className="flex justify-center items-center">
                 ...
                 <FaReact className="h-9 hover:text-gray-900 dark:hover:text-white w-[86px] "/>
              </a>
              <a href="#" className="flex justify-center items-center">
         
                <SiTailwindcss className="h-9 hover:text-gray-900 dark:hover:text-white w-[86px] "/>
              </a>
              <a href="#" className="flex justify-center items-center">
              
                <SiMongodb className="h-9 hover:text-gray-900 dark:hover:text-white w-[86px] "/>
              </a>

              <a href="#" className="flex justify-center items-center">
    
                <FaNodeJs className="h-9 hover:text-gray-900 dark:hover:text-white w-[86px] "/>
              </a>
              <a href="#" className="flex justify-center items-center">
               
                <SiWebrtc className="h-9 hover:text-gray-900 dark:hover:text-white w-[86px] "/>
              </a>
              <a href="#" className="flex justify-center items-center">
